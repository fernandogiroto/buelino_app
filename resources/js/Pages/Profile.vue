<template>
  ...
  <Content>
      <template #section>
          <Section title="Meu Perfíl" subtitle="Lar Estância">
          </Section>
      </template>
      <div class="card">
                <div class="row g-0">
                  <div class="col-12 col-md-3 border-end">
                    <div class="card-body">
                      <h4 class="subheader">Configurações</h4>
                      <div class="list-group list-group-transparent">
                        <a href="./settings.html" class="list-group-item list-group-item-action d-flex align-items-center active">Minha Conta</a>
                        <a href="#" class="list-group-item list-group-item-action d-flex align-items-center">Notificações</a>
                  ...
                  <div class="col-12 col-md-9 d-flex flex-column">
                    <div class="card-body">
                      ...
                      <h3 class="card-title">Detalhes do Perfíl</h3>
